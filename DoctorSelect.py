...
dr_bd_l=Label(dr_detail,text="MD.[Hom]\n B.H.M.S., N.H.M.C. (mumbai)",font=4).grid(column=4,row=4,padx=2,pady=1)

dr_c_l=Label(dr_detail,text="Dr.Ganesh Karad",font=17).grid(column=8,row=3,padx=2)
dr_bd_l=Label(dr_detail,text="Cardiac Surgeon,M.B.B.S.",font=4).grid(column=1,row=4,padx=2,pady=1)

dr_d_l=Label(dr_detail,text="Dr.Vijita Sharma",font=17).grid(column=10,row=3,padx=2)
dr_bd_l=Label(dr_detail,text="Cardiac Surgeon,M.B.B.S.",font=4).grid(column=1,row=4,padx=2,pady=1)
